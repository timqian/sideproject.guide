...
- 介绍你开发这个产品从 idea 到产品的过程形成博客发布到各个平台，人们最喜欢听故事
...
发布和分享产品是你找用户的方式，而搜索则是有需要的用户主动找到你。虽然效果不如主动分享立竿见影，但因为长尾效应，只要你做好了该做的优化，从搜索引擎来的用户数量更大，且更需要你做的产品。
懂得一些基本的搜索引擎优化的知识必不可少。搜索引擎优化曾经特别重要，有很多奇巧淫技帮助网站提高对于某些关键词的排名。但是随着各个搜索引擎的优化，慢慢很多
...
[知乎链接](https://daily.zhihu.com/story/8732855)
